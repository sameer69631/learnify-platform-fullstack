    ...
    return (
        <>
            <div className="bg-white">
                <div className='px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-14 lg:px-8'>
                    <div className='relative flex items-center justify-between'>
                        <div className='flex items-center'>
                            <NavLink to="/" className="inline-flex items-center mr-8">
                                <span className='ml-2 text-2xl font-bold text-green-700'>Learnify</span>
                            </NavLink>
                        </div>
